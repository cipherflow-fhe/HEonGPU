...
namespace heongpu
{
    ...
    template <> class Relinkey<Scheme::BFV>
    {
      ...
      public:
         ...
         * @company CipherFlow
         */
        __host__ Relinkey(HEContext<Scheme::BFV> context, int level,
        ...
        Relinkey(const Relinkey& copy)
            : context_(copy.context_), scheme_(copy.scheme_),
              ...
              r_prime_(copy.r_prime_), storage_type_(copy.storage_type_), // @company CipherFlow
    ...
    template <> class Switchkey<Scheme::BFV>
    {
      ...
      public:
         ...
         * @company CipherFlow
         */
        __host__ Switchkey(HEContext<Scheme::BFV> context, int level,
            const ExecutionOptions& options);
